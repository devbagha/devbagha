...
<details>
  ...
  <div align='center'>
    <img src="https://skillicons.dev/icons?i=py,pytorch,tensorflow,docker,githubactions,bash,js,fastapi,django,flask,selenium,php,laravel,asp.net,html,css,bootstrap,linux,git,postman,mysql,qt,figma" />
  </div>
